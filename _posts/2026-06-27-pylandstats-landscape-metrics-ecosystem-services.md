...
pylandstats 的价值在于把土地利用栅格从“面积统计图”升级为“空间格局变量库”。对生态系统服务、土壤保持、植被碳汇和喀斯特生态恢复研究来说，景观格局指标可以提供比面积变化更细的空间机制解释。

下一步值得做的是：选取 2000—2020 年土地利用产品，计算南方喀斯特区或贵州典型流域的景观格局变化，并将其与土壤保持率、NPP/GPP、生态系统服务指数和气候胁迫指标耦合，形成“土地利用格局—生态过程响应”的综合分析框架。
