---
title: "顶会论文拆解｜TimePro时序预测：从多变量滞后到生态NPP建模与一键代码改造"
...
tags:
  ...
  - Mamba
  - 栅格预测
excerpt: "拆解ICML 2025 TimePro的multi-delay、HyperMamba与time-tune机制，并将其改造成适合气候—NPP建模的月尺度/年尺度一键代码，讨论站点划分、历史Y、稀疏观测和栅格递推。"
---
